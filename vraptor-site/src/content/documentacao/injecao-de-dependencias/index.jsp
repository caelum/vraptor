...
<jsp:include page="/header.jsp">
	...
	'/>
		...
		<h2 class="chapter">Injeção de dependências</h2>
...
<h3 class="section">Providers</h3>
	    	<span class="paragraph">Por tr&aacute;s dos panos, o VRaptor utiliza um provider de DI espec&iacute;fico. Por padr&atilde;o o vraptor v&ecirc;m com suporte 
ao uso interno do Picocontainer ou do Spring IoC.</span>
	    	<span class="paragraph">Cada implementa&ccedil;&atilde;o disponibiliza tudo o que voc&ecirc; encontra na documenta&ccedil;&atilde;o do vraptor, mas acaba por fornecer
tamb&eacute;m pontos de extens&atilde;o diferentes, claro.</span>
		

<h3 class="section">Spring</h3>
	    	<span class="paragraph">Ao utilizar o Spring, voc&ecirc; ganha todas as caracter&iacute;sticas e componentes prontos do Spring para uso dentro do
VRaptor, isto &eacute;, todos os componentes que funcionam com o Spring DI/Ioc, funcionam com o VRaptor. Nesse caso,
todas as anota&ccedil;&otilde;es.</span>
...
<h3 class="section">Pico Container</h3>
	    	<span class="paragraph">Ao utilizar o Picocontainer por baixo do VRaptor, voc&ecirc; poder&aacute; acessar o pico diretamente para fazer 
configura&ccedil;&otilde;es avan&ccedil;adas que desejar.</span>
...
<h3 class="section">Seu próprio provider</h3>
