...
<head>
    ...
    <link href="${relative}/includes/css/menu.css" rel="stylesheet" type="text/css" media="screen" />
    <link href="${relative}/includes/css/xml2html.css" rel="stylesheet" type="text/css" media="screen" />
    <!--[if lt IE 7]>
...
<body>
	<div id="headerWrap">
    	<div id="headerContent">
            ...
            <ul id="langMenu">
            	<li><a id="engBtn" href="${menu}documentacao/en"><span>ENGLISH</span></a></li>
                <li><a id="ptBtn" href="${menu}documentacao/"><span>PORTUGUES</span></a></li>
            </ul><!-- langMenu-->            
        </div><!-- header content -->
    </div><!-- header wrap-->
