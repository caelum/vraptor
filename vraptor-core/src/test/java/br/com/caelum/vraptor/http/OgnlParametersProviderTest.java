...
public class OgnlParametersProviderTest {
    ...
    @Test
    public void isCapableOfDealingWithEmptyParameterForInternalWrapperValue() throws OgnlException, NoSuchMethodException {
        ...
        mockery.checking(new Expectations() {
            {
                ...
                one(nameProvider).parameterNamesFor(method); will(returnValue(new String[]{"House"}));
            }
        });
