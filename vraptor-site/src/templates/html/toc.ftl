...
<head>
	...
	<meta http-equiv="refresh" content="0;url=../${dirTree[1]}"/>
...
<body>
    ...
    <div id="menuWrap">
    	<ul id="menuElements">
        	<li><a id="homeBtn" href="/vraptor-site/"><span>home</span></a></li>
        	<li><a id="downloadBtn" href="/vraptor-site/download.jsp"><span>download</span></a></li>
        	<li><a id="documentacaoBtn" href="/vraptor-site/documentacao/"><span>Documentação</span></a></li>
        	<li><a id="beneficiosBtn" href="/vraptor-site/beneficios.jsp"><span>Benef&iacute;cios</span></a></li>
        	<li><a id="suporteBtn" href="/vraptor-site/suporte.jsp"><span>Suporte</span></a></li>
        	<li><a id="vraptor2Btn" href="/vraptor-site/vraptor2.jsp"><span>vraptor2</span></a></li>
        </ul><!-- menuElements-->
    </div><!-- menuWrap-->
