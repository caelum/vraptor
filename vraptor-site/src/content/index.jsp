    	...
    	<div id="banner">
            ...
            <div id="floatBoxBanner">
	            ...
	            <ul>
       	     	...
       	     	<a href="${path }/<fmt:message key='download.link'/>" id="downloadBtn2"><span>Download</span></a>
                <p><a href="${path }/<fmt:message key="saiba.mais.link"/>"><fmt:message key="saiba.mais"/></a> </p>
			</div><!-- content-float -->
