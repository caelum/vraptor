...
$.autocomplete = function(input, paramName, options) {
	...
	function makeUrl(q) {
		var url = options.url + "?" + options.paramName + "=" + q;
...
$.fn.autocomplete = function(url ,paramName , options) {
	...
	options.paramName = paramName || "q";

	this.each(function() {
		var input = this;
		new $.autocomplete(input, paramName, options);
	});
