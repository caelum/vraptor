...
//		this.resourceConfig = new DefaultResourceConfig(x);
	...
	public JerseyResourceComponentMethod findComponent(InterceptorStack stack,
		...
		HttpServletResponseWrapper fakeResponse = new HttpServletResponseWrapper((HttpServletResponse) resp){
		...
		final RequestUriParser parser = new RequestUriParser(req, fakeResponse, webComponent);
		...
		Iterator<UriRule> rules = (Iterator<UriRule>) req.getAttribute(
